...
inherit native autotools pkgconfig systemd
...
DEPENDS_${PN}-native = "glib-2.0-native e2fsprogs-native gpgme attr libsoup-2.4-native libassuan xz systemd flex-native bison-native "
